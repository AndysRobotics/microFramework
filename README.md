...
It is very lightweight (v1.0.004 is 12.1KB or 5.6KB minified) and will only render when required. There is no virtual DOM, all interaction with the DOM is via `data-` attribute tags.
