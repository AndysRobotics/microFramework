...
It is very lightweight (v1.0.005 is 12.5KB or 5.8KB minified) and will only render when required. There is no virtual DOM, all interaction with the DOM is via `data-` attribute tags.
